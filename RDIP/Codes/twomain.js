...
function continuebtn() {
  ...
  answer.innerHTML =
    "<center><button id='submit1' value='Submit' onclick='stemming()'>Submit</button></center>";
}
...
function experimentshow() {
  ...
  document.getElementById('image1').style.display = 'none';
  description.innerHTML =
    "<center><select id='corpus' onchange = 'dropdownchange()'><option value='select'>---Select a corpus---</option><option value='corpus1'>Corpus 1</option><option value='corpus2'>Corpus 2</option><option value='corpus3'>Corpus 3</option></select></center>";
}
